      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <p>Our customers have since being part of us, became financially free with a steady income source.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <p>ROI offered by CRYPTAN CI can't be matched by any bank while still enjoying full coverage of insurance.</p>
          </div>
        </div>
